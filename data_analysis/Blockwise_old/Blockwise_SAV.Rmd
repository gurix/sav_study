...
```{r}
block1 <- lm(explicit_acceptance ~ general_context_positive_antizipation + general_context_autonomy + general_context_aversion + general_context_driving_enjoyment, data=dataset);summary.lm(block1)
lm.beta(block1)
