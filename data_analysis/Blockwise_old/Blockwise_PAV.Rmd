---
title: "Blockwise Variable Selection PAV"
author: "Markus Graf"
date: "10 8 2017"
...
dataset <- subset(valid_sessions.pav, route_costs > 0)
```

## Block 1 Context factors
```{r}
block1 <- lm(explicit_acceptance ~ context_positive_antizipation + context_autonomy + context_aversion + context_driving_enjoyment, data=dataset);summary.lm(block1)
lm.beta(block1)
